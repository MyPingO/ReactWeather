...
function WeatherCard(props) {
    ...
    return data ? (
        ...
        <div className={`card ${className} ${weatherDescription.replaceAll(" ", '')}`}>
            <div className="card-body">
                ...
                <p className="card-text description">
                    ...
                    {/* <div className="rainstats" style={{display: "flex", justifyContent: "center"}}> */}
                        {getRainIcon(dailyData.rain ? dailyData.rain : 0)} {dailyData.rain ? dailyData.rain.toFixed(2) : 0}
                        mm<br />
                    {/* </div> */}
